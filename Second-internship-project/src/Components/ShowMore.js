...
export default function ShowMore() {
  ...
  return (
    <div className="">
      {showCards && (
        <div className="mt-4 mx-auto grid grid-cols-3 gap-4 w-[95%]">
          {/* Add your grid card components here */}
          {/* Card one */}
          <div className="bg-white rounded-lg shadow-md p-3 relative hover:scale-105 transition duration-300">
            ...
            <img
              src="/images/bOne.jpg"
              alt=""
              className="w-[400px] h-[240px] mx-auto rounded-xl"
            />
            ...
            <div className="pt-5 pl-2 text-[18px] font-bold">
              <p>
                RCE Theaters - 907 S Beckford Dr, <br /> Henderson, NC 27536
              </p>
            </div>
            ...
            <div className="flex justify-between">
              <p className="mt-4">
                <span className="text-[20px] text-blue-700 text-bold">
                  $7,255
                </span>
                /month
              </p>
          ...
          <div className="bg-white rounded-lg shadow-md p-3 relative hover:scale-105 transition duration-300">
            ...
            <div className="Popular-tag">
              <img
                src="/images/popularTag.png"
                alt=""
                className="absolute w-[120px] bottom-[47%] left-[-0.002%]"
              />
            </div>
            ...
            <div className="pt-5 pl-2 text-[18px] font-bold">
              <p>
              Regal North Hills - 4150 Main at North <br /> Hills St, Releigh
              </p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-3 relative hover:scale-105 transition duration-300">
            ...
            <div className="pt-5 pl-2 text-[18px] font-bold">
              <p>
              Costco Wholesale - 1021 Oak Forest <br /> Ln, Myrtle Beach, SC
              </p>
            </div>
      ...
      {/* Centered flex container with a cursor pointer on hover */}
      <div className="flex items-center justify-center hover:cursor-pointer">
        ...
        <img
          ...
          alt=""
          className="w-[200px] h-[200px] hover:scale-110 transition duration-300"
        />
      </div>
    </div>
  );
